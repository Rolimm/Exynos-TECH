...
if ($resultado_usuario) {
	echo "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=http://localhost/Exynos%20TECH/login/login.php'>
	<script language='javascript'>
	window.alert('Usuário criado com sucesso!');
	</script>";
} else {
	echo "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=http://localhost/Exynos%20TECH/cadastro/cadastro.php'>
	<script language='javascript'>
